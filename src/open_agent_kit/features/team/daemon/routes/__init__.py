"""Route modules for the Team daemon.
...
from open_agent_kit.features.team.daemon.routes.activity import (
    router as activity_router,
)
from open_agent_kit.features.team.daemon.routes.activity_management import (
    router as activity_management_router,
)
from open_agent_kit.features.team.daemon.routes.activity_plans import (
    router as activity_plans_router,
)
from open_agent_kit.features.team.daemon.routes.activity_processing import (
    router as activity_processing_router,
)
from open_agent_kit.features.team.daemon.routes.activity_relationships import (
    router as activity_relationships_router,
)
from open_agent_kit.features.team.daemon.routes.activity_sessions import (
    router as activity_sessions_router,
)
from open_agent_kit.features.team.daemon.routes.agent_runs import (
    router as agent_runs_router,
)
from open_agent_kit.features.team.daemon.routes.agent_settings import (
    router as agent_settings_router,
)
from open_agent_kit.features.team.daemon.routes.backup import (
    router as backup_router,
)
from open_agent_kit.features.team.daemon.routes.config import (
    router as config_router,
)
from open_agent_kit.features.team.daemon.routes.config_exclusions import (
...
from open_agent_kit.features.team.daemon.routes.config_test import (
    router as config_test_router,
)
from open_agent_kit.features.team.daemon.routes.devtools_processing import (
    router as devtools_processing_router,
)
from open_agent_kit.features.team.daemon.routes.health import (
    router as health_router,
)
from open_agent_kit.features.team.daemon.routes.hooks import router as hook_router
from open_agent_kit.features.team.daemon.routes.index import router as index_router
from open_agent_kit.features.team.daemon.routes.mcp import router as mcp_router
from open_agent_kit.features.team.daemon.routes.notifications import (
    router as notifications_router,
)
from open_agent_kit.features.team.daemon.routes.otel import router as otel_router
from open_agent_kit.features.team.daemon.routes.search import (
    router as search_router,
)
from open_agent_kit.features.team.daemon.routes.search_network import (
    router as search_network_router,
)
from open_agent_kit.features.team.daemon.routes.team import (
    router as team_router,
)
from open_agent_kit.features.team.daemon.routes.ui import router as ui_router
