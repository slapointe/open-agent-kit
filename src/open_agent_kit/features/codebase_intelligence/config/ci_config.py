"""CIConfig — top-level Codebase Intelligence configuration."""
...
from open_agent_kit.features.codebase_intelligence.config.embedding import EmbeddingConfig
from open_agent_kit.features.codebase_intelligence.config.governance import GovernanceConfig
