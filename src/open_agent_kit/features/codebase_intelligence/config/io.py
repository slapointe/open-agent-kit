"""Configuration I/O and classification for Codebase Intelligence.
...
# Path: features/codebase_intelligence/config/io.py -> config/ -> codebase_intelligence/ -> features/ -> open_agent_kit/
