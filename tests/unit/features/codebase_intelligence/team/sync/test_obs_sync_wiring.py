...
class TestInitTeamSyncWiring:
    ...
    def test_applier_wired_when_relay_client_present(self, store):
        ...
        with (
            patch(
                "open_agent_kit.features.codebase_intelligence.daemon.lifecycle.startup.get_state",
                return_value=mock_state,
            ),
            patch(
                "open_agent_kit.features.codebase_intelligence.team.outbox.worker.ObsFlushWorker"
            ) as mock_worker_cls,
            patch(
