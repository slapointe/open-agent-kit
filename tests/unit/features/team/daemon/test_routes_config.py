...
class TestConfigTest:
    ...
    @patch("open_agent_kit.features.team.embeddings.provider_chain.create_provider_from_config")
    ...
    def test_test_config_embedding_generation(self, client, setup_state_with_project):
        ...
        with patch(
            "open_agent_kit.features.team.embeddings.provider_chain.create_provider_from_config"
        ) as mock_create:
            mock_provider = MagicMock()
            mock_provider.name = "ollama"
            mock_provider.is_available = True
...
class TestRestartDaemon:
    ...
    def test_restart_detects_model_change(self, client, setup_state_with_project):
        ...
        with patch("open_agent_kit.features.team.config.load_ci_config") as mock_load:
            with patch(
                "open_agent_kit.features.team.embeddings.provider_chain.create_provider_from_config"
            ) as mock_create:
...
class TestTestSummarizationConfig:
    ...
    @patch("open_agent_kit.features.team.summarization.create_summarizer")
...
class TestDiscoverContextTokens:
    ...
    @patch("open_agent_kit.features.team.summarization.discover_model_context")
