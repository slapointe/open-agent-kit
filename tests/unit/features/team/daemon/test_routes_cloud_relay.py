...
_PATCH_GET_PORT = "open_agent_kit.features.team.daemon.routes.cloud_relay._get_daemon_port"
_PATCH_CLIENT_CLS = "open_agent_kit.features.team.cloud_relay.client.CloudRelayClient"
_SCAFFOLD_MODULE = "open_agent_kit.features.team.cloud_relay.scaffold"
_DEPLOY_MODULE = "open_agent_kit.features.team.cloud_relay.deploy"
...
class TestCloudRelaySettings:
    ...
    def test_settings_rerenders_wrangler_when_scaffolded(self, client: TestClient) -> None:
        ...
        _PATCH_SETTINGS_IS_SCAFFOLDED = (
            "open_agent_kit.features.team.cloud_relay.scaffold.is_scaffolded"
        )
        _PATCH_SETTINGS_RENDER_WRANGLER = (
            "open_agent_kit.features.team.cloud_relay.scaffold.render_wrangler_config"
        )
